        ...
        <div class="product-container">
            ...
            <div class="product-details">
                ...
                <div class="quantity-section">
                    <p class="quantity-available">$qteStock</p>
                    <p class="quantity-stock">$qteSeuil</p>
                </div>
                <p class="price">$prixCons FCFA</p>
            </div>
            <div class="product-actions">
                <button type="button" class="action-button"><img src="../../image/icon/attribuer.svg" alt="Attribuer" class="action-icon" title="Attribuer le consommable"></button>
                <button type="button" class="action-button"><img src="../../image/icon/commander.svg" alt="Commander" class="action-icon" title="Commander le consommable"></button>
                <button type="button" class="action-button"><img src="../../image/icon/modifier.svg" alt="Modifier" class="action-icon" title="Modifier le consommable"></button>
                <button type="button" class="action-button"><img src="../../image/icon/supprimer.svg" alt="Supprimer" class="action-icon" title="Supprimer le consommable"></button>
            </div>
        </div>
    CON;
